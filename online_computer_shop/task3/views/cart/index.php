...
<section class="page-head">
    <div>
        <h1>My Cart</h1>
        <p>Update quantity, remove items, and check your total price.</p>
    </div>
...
<?php else: ?>
    <section class="cart-card">
        ...
        <div class="cart-summary">
            ...
            <a class="primary-btn" href="#" title="Task 4 will implement checkout and order placement">Checkout in Task 4</a>
        </div>
    </section>
<?php endif; ?>
